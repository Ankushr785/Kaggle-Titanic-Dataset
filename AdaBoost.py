...
clf = AdaBoostClassifier(n_estimators = 150, base_estimator=dt, algorithm = "SAMME.R")
model3 = clf.fit(titanic, y)

#check the cross validation score
from sklearn.cross_validation import cross_val_score

score = cross_val_score(model3, titanic, y, cv = 10)
...
sol.to_csv('Solution3.csv')

#the accuracy is found to be 0.695856
